...
const Advisor = () => {
  return (
    ...
    <div className='container px-4 md:px-6 xl:px-0 xl:max-w-[1140px] 3xl:max-w-[1580px] mx-auto'>
        ...
        <p className='text-light_gray text-center text-[15px] max-w-[625px] mx-auto'>Our advisory board is made up of some of the finest minds in finance, crypto and engineering</p>
